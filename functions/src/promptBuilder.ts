...
CALENDAR MATH: Compute things like "end of this month" or "next Friday" yourself using the anchor date above. Always return absolute ISO 8601 dates/times in the output — never a relative string.${audioNote}${clarificationNote}
