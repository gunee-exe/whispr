      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: voiceState.isRecording
              ? WhisprColors.sparkCyan.withValues(alpha: 0.6 + voiceState.amplitude * 0.4)
        ...
        boxShadow: [
          BoxShadow(
            color: voiceState.isRecording
                ? WhisprColors.sparkCyan.withValues(alpha: 0.15 + voiceState.amplitude * 0.2)
      ...
      children: [
        ...
        Text(
          ...
          style: WhisprText.body(size: 14, color: WhisprColors.mutedInk),
            ...
            .shimmer(duration: 1200.ms, color: WhisprColors.sparkCyan.withValues(alpha: 0.4)),
      ],
    );
  }
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: voiceState.isRecording
              ...
              : WhisprColors.sparkCyan.withValues(alpha: 0.12),
