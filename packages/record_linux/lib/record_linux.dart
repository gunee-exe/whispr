...
class RecordLinux extends RecordPlatform {
  ...
  /// Patched: added optional {bool request = true} to match record_platform_interface 1.5.x.
  @override
  ...
  /// Patched: startStream added to satisfy record_platform_interface 1.5.x abstract method.
  /// Linux streaming is not supported — throws immediately so callers can handle gracefully.
  @override
  Future<Stream<Uint8List>> startStream(
      String recorderId, RecordConfig config) async {
    throw UnsupportedError(
        'startStream is not supported on Linux with record_linux 0.7.2.');
  }
